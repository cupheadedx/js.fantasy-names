...
function generator$miscellaneous$musicianNames(type){
	...
	var nm5 = ["Angel","Animal","Aspect","Awe","Axis","Badger","Base","Bass","Bear","Bird","Bizarre","Blade","Blaze","Blue","Blush","Boar","Bogus","Boss","Brash","Brass","Brawn","Brick","Buddy","Cage","Cannon","Case","Cash","Cell","Chain","Chains","Chaos","Chase","Cloud","Coal","Coil","Cord","Crash","Crib","Crime","Crow","Curves","Darkness","Doc","Edge","Ego","Electric","Enigma","Envy","Escape","Face","Fade","Fang","Fangs","Fire","Flame","Flock","Flow","Flux","Fog","Force","Ghost","Gold","Green","Groef","Habit","Harm","Heart","Horn","Ice","Impulse","Ink","Iron","Jacket","Jade","Jewel","Judge","Justice","Kid","Kite","Legion","Life","Light","Link","Lock","Locket","Love","Luck","Mask","Medium","Mercy","Method","Might","Mind","Mine","Minute","Mirror","Moon","Mouse","Muse","Nerve","Night","Nightowl","Omen","One","Owl","Patch","Pest","Phase","Pitch","Poet","Poison","Pool","Price","Pride","Prize","Pulse","Push","Quartz","Quill","Quince","Quiver","Rain","Raw","Ray","Reaper","Red","Rice","Ride","Rise","Robin","Rose","Rush","Scratch","Shade","Shadow","Shift","Silk","Silver","Sky","Slice","Smile","Smoke","Snow","Spade","Spark","Spirit","Sprite","Status","Steel","Stitch","Storm","Stranger","Sugar","Tails","Tales","Tank","Tear","The Edge","Throne","Thunder","Tiger","Tune","Two","Veil","Vessel","Voyage","Web","Weird","Whistle","Wind","Wing","Wings","Wish","Yellow","Youth","Zephyr"];
