function generator$miscellaneous$test(){
	i = Math.floor(Math.random() * 10);
			...
			var random3 = parseInt(Math.floor((Math.random() * names1.length)));

			var random4 = parseInt(Math.floor((Math.random() * names2.length)));	

			var random5 = parseInt(Math.floor((Math.random() * names1.length)));

			var random6 = parseInt(Math.floor((Math.random() * names2.length)));

			var random7 = parseInt(Math.floor((Math.random() * names1.length)));

			var random8 = parseInt(Math.floor((Math.random() * names2.length)));		

			var random9 = parseInt(Math.floor((Math.random() * names1.length)));

			var random10 = parseInt(Math.floor((Math.random() * names2.length)));	

			var random11 = parseInt(Math.floor((Math.random() * names1.length)));

			var random12 = parseInt(Math.floor((Math.random() * names2.length)));

			var random13 = parseInt(Math.floor((Math.random() * names1.length)));

			var random14 = parseInt(Math.floor((Math.random() * names2.length)));	

			var random15 = parseInt(Math.floor((Math.random() * names1.length)));

			var random16 = parseInt(Math.floor((Math.random() * names2.length)));

			var random17 = parseInt(Math.floor((Math.random() * names1.length)));

			var random18 = parseInt(Math.floor((Math.random() * names2.length)));		

			var random19 = parseInt(Math.floor((Math.random() * names1.length)));

			var random20 = parseInt(Math.floor((Math.random() * names2.length)));			

			var name = names1[random1] + " " + names2[random2];

			var name2 = names1[random3] + " " + names2[random4]	

			var name3 = names1[random5] + " " + names2[random6]	

			var name4 = names1[random7] + " " + names2[random8]	

			var name5 = names1[random9] + " " + names2[random10]	

			var name6 = names1[random11] + " " + names2[random12]	

			var name7 = names1[random13] + " " + names2[random14]	

			var name8 = names1[random15] + " " + names2[random16]	

			var name9 = names1[random17] + " " + names2[random18]	

			var name10 = names1[random19] + " " + names2[random20]				
