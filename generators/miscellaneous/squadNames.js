...
var names3 = ["Advanced","Classified","Covert","Crisis","Disaster","Emergency","Extreme","Incident","Pressure","Situational","Special","Specialized","Standby","Strategic","Tactical","Trauma"];
var names4 = ["Airborne","Assault","Assemble","Combat","Command","Control","Evaluation","Counter","Engage","Force","Intelligence","Liberation","Maintenance","Management","Mobilization","Operation","Organization","Pursuit","Reinforce","Reconnaissance","Relief","Rescue","Response","Retaliation","Salvage","Service","Support","Task","Tracking","Training","Weapons"];
var names5 = ["Crew","Division","Squad","Squadron","Team","Unit"];
var names6 = ["Crew","Squad","Squadron"];
function generator$miscellaneous$squadNames(){
