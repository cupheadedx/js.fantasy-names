...
function nameGen(type){
	...
	var nm3 = ["Abbot","Abbott","Akkerman","Alderman","Archer","Arkwright","Arrowsmith","Bacchus","Bailey","Baker","Baxter","Bekker","Bender","Berger","Boatwright","Bowman","Brewer","Brewster","Butler","Campion","Candler","Cantrell","Carpenter","Carrin","Carter","Cartwright","Carver","Cater","Century","Chaffer","Chafter","Chalker","Challender","Chamberlain","Chambers","Chaplin","Chapman","Cherrier","Chessman","Clark","Cleaver","Coldren","Coleman","Collier","Conner","Cook","Cooper","Cotter","Crowther","Day","Dexter","Drage","Draper","Dyer","Dyster","Farrar","Faulkner","Fearson","Fisher","Flax","Fletcher","Foal","Forester","Foster","Fowler","Frobisher","Fuller","Gage","Gardiner","Gardner","Glover","Graves","Hammer","Harper","Hayward","Heard","Hinman","Hogg","Hooper","Hunter","Inman","Kantor","Kellogg","Key","Kisser","Knight","Lander","Leadbetter","Lister","Lorimer","Lush","Machin","Marshall","Mason","Mercer","Miller","Mills","Milner","Mulliner","Nader","Naylor","Page","Paget","Paige","Palmer","Parker","Parson","Piper","Plummer","Potter","Proctor","Provost","Purcell","Redman","Rock","Rocker","Ryder","Sadler","Salter","Sargent","Sawyer","Scully","Seal","Seales","Sexton","Shepherd","Shields","Singer","Smith","Smythe","Spencer","Spicer","Stanier","Stewart","Stonier","Stringer","Tabor","Tanner","Tasker","Taverner","Taylor","Thatcher","Tiller","Tillman","Todd","Toller","Trainer","Tranter","Trapp","Travers","Trinder","Tucket","Turner","Tyler","Tyrer","Voss","Walker","Waller","Ward","Warf","Warner","Warrer","Wayne","Webb","Webster","Woodward","Wright"];
	var tp = type;
