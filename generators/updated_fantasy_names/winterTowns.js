...
function nameGen(){
	var nm1 = ["Arcta","Arcti","Avala","Avalan","Blizz","Blyz","Boots","Brisque","Chill","Chillis","Cristal","Cryo","Crystal","Drift","Firn","Flaike","Flake","Flo","Flurris","Frigid","Fross","Frost","Frostbite","Fyre","Glace","Glacia","Glacier","Glacis","Glaize","Gliss","Hayle","Hearth","Hiber","Hiver","Ice","Iglis","Lanche","Melte","Mitten","Mittens","N̩v̩","Neige","Onding","Quilt","Rime","Shiver","Sleat","Sleath","Sled","Sledge","Sleet","Slush","Snift","Sno","Snow","Solstice","Thaw","Thawe","Thermia","Thermis","Thermos","Wind","Winde","Winter","Wool","Wynter","Yce"];
