...
var nm2 = ["a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u",,"Ã¤","e","i","Ã¬","o","u","aw","ay","ew","ey"];
var nm3 = ["a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u",,"a","Ã¤","e","i","Ã¬","o","u","aw","ay","ew","ey","rr","ll"];
...
function nameGen(type){
	...
	for(i = 0; i < 10; i++){
		...
		for(j = 0; j < rndFn; j++){
			...
			if(rndEnd === 1){
				nm2a = ["a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u","aw","ay","ew","ey"];
				...
				if(nm1[rnd] === ""){
					...
					nm2a = ["a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u","aw","ay","ew","ey","rr","ll"];
				}
				nmEnd = [""];
				rnd4 = 0;
			}
			if(rndDv === 1){
				nm2 = ["a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u","a","Ã¤","e","i","Ã¬","o","u","aw","ay","ew","ey"];
