ï»¿var nm1 = ["","","","","","b","c","d","f","g","h","j","k","l","m","n","p","q","r","s","t","v","w","x","y","z","bl","br","ch","cl","dh","fr","fl","gh","gr","sh","tr"];
...
var nm5 = ["","","","","","","","Abboccato","Acescence","Adamado","Adega","Amabile","Annata","Bianco","Blanc","Blanco","Branco","CÃ©page","Cap Classique","Cava","Chiaretto","Clairet","Classic","Demi-Sec","Doce","Dolce","Doux","Dulce","Edes","Frizzante","Fume","Garrafeira","Granvas","Halbtrocken","Invecchiato","Liquoroso","Mousseux","Noir","PÃ©tillant","Piquant","Rich","Rosado","Rosato","Rosso","Rouge","SÃ¼ss","Sec","Secco","SzÃ¡raz","Vendemmia","Vendimia","Viejo","d'Or"];
var br = "";
