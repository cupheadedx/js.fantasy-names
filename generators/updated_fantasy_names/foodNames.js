...
ï»¿function nameGen(){
	...
	for(i = 0; i < 10; i++){
		if(i < 6){
			...
			if(i < 8){
				rnd3 = Math.random() * names6.length | 0;	
				while(rnd3 === rnd){
					rnd3 = Math.random() * names6.length | 0;	
				}
