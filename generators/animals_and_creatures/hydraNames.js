...
var nm3 = ["g","k","m","n","r","v","z","g","h","k","m","n","r","v","z","g","k","m","n","r","v","z","g","k","m","n","r","v","z","g","k","kk","ll","m","mm","n","nn","r","ss","v","z","zz","ch","g","gz","gr","gn","g","h","hj","hsh","hz","k","kk","kh","ll","m","mm","mz","n","ng","nn","nz","nk","ngr","r","rd","rg","rz","sh","ss","shg","shk","sk","ssh","ssk","sz","v","vh","z","zr","zsh","zg","zk","zz"];
...
function generator$animals_and_creatures$hydraNames(type){
