ï»¿var nm1 = ["Ag","Aln","Aran","Arn","Bald","Beorn","Beran","Borg","Both","Dag","Darn","Dreng","Dug","Eld","Erad","Eran","Ern","Fer","Forn","Frid","Froth","Gal","Glum","Gluth","Grim","Har","Hart","Heim","Hroth","Ig","Ingel","Is","Iw","Jal","Jar","Jarn","Jorn","Log","Lor","Lyd","Lyth","Mag","Mar","Morn","Moth","Nard","Ned","Nef","Nor","Old","Ord","Ot","Oth","Rand","Rath","Ric","Rod","Sig","Skal","Skol","Stig","Tar","Theod","Thor","Throt","Val","Vald","Vig","Vul","Wal","Wald","Wid","Wul"];
var nm2 = ["ald","angar","ard","aric","bald","beorn","bert","bold","brand","dar","dhor","dam","dan","fald","fara","fast","forn","gÃ¡r","geir","gils","grim","hame","har","helm","here","kald","kar","karl","kin","mÃ³d","mar","mark","moth","mund","ohd","ond","or","oric","rand","rath","rek","ric","sel","sorn","stin","styr","tar","taric","thorn","torn","var","vat","vir","vith","wald","war","wine","wulf"];
