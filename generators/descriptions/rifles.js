function generator$descriptions$rifles() {
	...
	var rnd18 = Math.floor(Math.random() * nm17.length);
	while (rnd18 === rnd17) {
	...
	var rnd24a = Math.floor(Math.random() * nm24.length);
	var rnd24b = Math.floor(Math.random() * nm24.length);
	while (rnd24a === rnd24b) {
	...
	var rnd30a = Math.floor(Math.random() * nm30.length);
	var rnd30b = Math.floor(Math.random() * nm30.length);
	var rnd31a = Math.floor(Math.random() * nm31.length);
	var rnd31b = Math.floor(Math.random() * nm31.length);
	var rnd31c = Math.floor(Math.random() * nm31.length);
	var rnd31d = Math.floor(Math.random() * nm31.length);
