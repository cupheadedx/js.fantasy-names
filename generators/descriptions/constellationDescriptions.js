function generator$descriptions$constellationDescriptions(){
	i = Math.floor(Math.random() * 10);
			...
			var name = "Made up of " + names1[random1] + " stars, the constellation called " + names2[random2] + " roughly resembles the shape of a " + names3[random3];

			var name2 = ". It can be seen most prominently " + names4[random4] + " " + names5[random5] + ".";

			

			var name3 = "In an ancient society, this constellation was seen as the representation of the god of " + names6[random6] + ", which is how it received the name still used today.";

			

			var name4 = "In astrology, this constellation bears the sign of " + names7[random7] + ", those born under it are believed to " + names8[random8] + ".";

			var name5 = "They're suposed to be a good match with those born under the constellations resembling a " + names3[random9] + names9[random10] + " and " + names3[random11] + ". ";

			var name6 = "But they don't match well with those born under the " + names3[random12] + names9[random13] + " and " + names3[random14] + " constellations.";
